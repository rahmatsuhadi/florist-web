...
const StorefrontMapPicker = dynamic(
  () => import("@/components/features/admin/storefront/molecules/map/StorefrontMapPicker"),
    ...
    <div className="bg-white p-6 rounded-2xl border border-brand/10 shadow-sm space-y-5">
      ...
      <div className="space-y-5">
        <div className="space-y-1.5">
          ...
          {errors?.openingHours && <p className="text-xs text-red-500">{errors.openingHours[0]}</p>}
        </div>
