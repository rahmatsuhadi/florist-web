        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-brand focus:ring-1 focus:ring-brand outline-none transition-all bg-white/50"
          ...
          <button
            ...
            className="w-full py-3.5 bg-brand text-white rounded-xl font-medium hover:bg-brand-hover active:scale-[0.98] transition-all flex justify-center items-center gap-2"
          >
            {isSubmitting ? (
              <motion.div
                animate={{ rotate: 360 }}
